 ...
 */
package hu.javagladiators.education.hoe.vehiclelevel.dao.models;
...
public class VehicleLevel implements Serializable {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof VehicleLevel)) {
            return false;
        }
        VehicleLevel other = (VehicleLevel) object;
        if (this.id != other.id) {
            return false;
        }
        return true;
    ...
    public String toString() {
        return "hu.javagladiators.education.hoe.vehiclelevel.dao.model.VehicleLevel[ id=" + id + " ]";
    }
}
